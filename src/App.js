...
const initCategories = ["Programming", "Web Development"];
const initBlogs = [
  {
    id: 1,
...
function App() {
  ...
  const postsByCategories = ({ match }) => {
    ...
    let p = posts.filter(
      post => post.blogId == blogId && post.category.toLowerCase() == category
    );
          ...
          <div className="content-wrapper">
            ...
            <div className="content-area">
              <Switch>
                ...
                <Route
                  path="/posts/:blogId/categories/:category"
                  render={postsByCategories}
                />
              </Switch>
            </div>
          </div>
